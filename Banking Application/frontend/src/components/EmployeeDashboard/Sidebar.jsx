...
import {FaBuilding, FaCalendar, FaCalendarAlt, FaCogs, FaMoneyBill, FaMoneyBillWave, FaTachometerAlt, FaUsers} from 'react-icons/fa'
  ...
  return (
    <div className='bg-gray-800 text-white h-screen fixed left-0 top-0 bottom-0 space-y-2 w-64'>
        ...
        <div className='bg-teal-600 h-12 flex items-center justify-center'>
            <h3 className='google-font text-2xl text-center'>Employee MS</h3>
        </div>
