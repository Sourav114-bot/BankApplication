  ...
  return (
    <div className='p-6'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-4 mt-6'>
            ...
            <SummaryCard icon={<FaUsers/>} text="Monthly Salary" number={summary.totalSalary} color='bg-red-600'/>
        </div>
        ...
        <div className='mt-12'>
            ...
            <SummaryCard icon={<FaHourglassHalf/>} text="Leave Pending" number={summary.leaveSummary.pending} color='bg-pink-600'/>
